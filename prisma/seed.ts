...
async function main() {
  ...
  const acts: ActData[] = [
    ...
    },
    {
      ...
      locatie: 'KU Leuven',
      organisator: 'European Building Network',
    ...
    },
    {
      ...
      organisator: 'Estudio Carme Pinós',
    ...
    },
    {
      ...
      organisator: 'Startup Weekend Belgium',
      beentje: 'ONDERNEMEND', niveau: 1,
    ...
    },
    {
      ...
      startuur: '09:00', einduur: '17:00',
      locatie: 'PXL Innovation Lab',
      organisator: 'Flanders Investment & Trade',
      beentje: 'ONDERNEMEND', niveau: 2,
      maxPlaatsen: 25, aantalIngeschreven: 2,
      aangemaaktDoorId: docentMulti.id, opleidingId: it.id,
    },
  ...
  await prisma.activiteit.upsert({
    ...
    create: {
      ...
      organisator: 'Jeugdwerk Genk vzw',
